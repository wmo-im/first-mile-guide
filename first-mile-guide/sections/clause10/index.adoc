...
To balance network transmission costs for Metadata Messages (which are typically significantly larger than Data Messages) with impost of storing Data messages until the relevant Metadata message is received and the Data Messages can be understood, recommended practice is (re)sending of the Metadata Message:
