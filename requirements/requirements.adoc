...
* Both `Metadata` and `Data` messages should be wrapped in a `FirstMileMessage` and published to topic in the following format: `firstmile/[version]/[vendor_name]/hostId`, with QoS=1.
