...
* The `Metadata` message should be published to topic in the following format: `firstmile/[version]/[vendor_name]/metadata/hostId`, with retain flag set to 1 and with QoS=2.
* The `Data` message should be published to topic in the following format: `firstmile/[version]/[vendor_name]/data/hostId`, with retain flag set to 0 and with QoS=1.
